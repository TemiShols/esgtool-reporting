...
from .views import FuelModelViewSet, WasteModelViewSet, ElectricityModelViewSet, HeatingModelEmissionViewSet, \
    ResultViewSet, TransportModelEmissionsViewSet, HomeHeatingModelEmissionViewSet, RefrigerantModelEmissionsViewSet, \
    CarModelEmissionsViewSet
...
router.register(r'chp-emissions', HeatingModelEmissionViewSet)
router.register(r'heating-emissions', HomeHeatingModelEmissionViewSet)
router.register(r'car-emissions', TransportModelEmissionsViewSet)
router.register(r'results', ResultViewSet)
router.register(r'refrigerant-emissions', RefrigerantModelEmissionsViewSet)
router.register(r'transport-emissions', CarModelEmissionsViewSet)

...
from .views import calculate_fuel_emissions, view_fuel_emissions, calculate_waste_emissions, calculate_electricity_emissions, view_electricity_emissions,\
                    ...
                    calculate_refrigerant_emissions, view_transport_emissions, view_results, create_car, view_refrigerant_emissions
...
urlpatterns = [
    ...
    path('calculate-transport-=emissions', create_car, name='calculate_transport_emissions'),
    ...
    path('view-refrigerant-emissions/<int:pk>', view_refrigerant_emissions, name='view_refrigerant_emissions'),
